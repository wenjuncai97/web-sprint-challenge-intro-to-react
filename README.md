...
React is great at handling dynamic data at a fast response time. React responds to data changes instantly and renders the right components when needed. 
2. Describe component state.
Component state is an object that holds information that may change over time in the component. 
3. Describe props.
Props are arguments passed into React components. Props is short for properties.
4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side effects can be anything that affects something outside of the scope of the current function that's being executed. 